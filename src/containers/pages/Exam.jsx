...
import ExamTableRow from "../../components/exam";
      ...
      <div className="card mb-5 mb-xl-8">
        ...
        <div className="card-body py-3">
          ...
          <div className="table-responsive">
            {/*<!--begin::Table--> */}
            <table className="table align-middle gs-0 gy-4" id="exam_table">
              {/*<!--begin::Table head--> */}
              <thead>
                <tr className="fw-bold text-muted bg-light">
                  <th className="ps-4 rounded-start">#</th>
                  <th className="mi-w-325px">Alumno</th>
                  <th className="mi-w-125px">Examen</th>
                  <th className="mi-w-125px">Lugar</th>
                  <th className="mi-w-125px">Aula</th>
                  <th className="mi-w-125px">Fecha</th>
                  <th className="mi-w-150px">Nota</th>
