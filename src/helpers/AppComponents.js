    ...
    let initSmoothScroll = function() {
      ...
      if (element instanceof Element) {
        ...
        if (document.body.contains(element)) {
          // obten la posición y tamaño del elemento
          ...
          // haz algo con la posición y tamaño obtenidos
        } else {
          console.warn('El elemento no ha sido agregado al DOM');
        }
      } else {
        console.warn('El objeto no es un elemento del DOM');
      }
...
/*     let _destroy = function() {
  ...
  KTMenu.init = function() {
    ...
    //console.log(KTMenuHandlersInitialized)
  ...
  let KTSearch = function(element, options) {
    ...
    let _focus = function() {
      ...
      if (
        ...
        the.inputElement.value.length >= defaultOptions.minLength
      ) {
        _show();
      }
    };
  ...
  let KTUtil = (function() {
    ...
    return {
      ...
      getScroll: function(element, method) {
        ...
        const browserSupportsBoxModel =
          window.innerWidth && document.documentElement.clientWidth
            ? window.innerWidth === document.documentElement.clientWidth
            : true;
        return element == window || element == document
          ? window[method == "scrollTop" ? "pageYOffset" : "pageXOffset"] ||
...
/*   let KTAppLayoutBuilder = (function() {
    ...
    let handleEngagePrebuilts = function() {
      ...
      if (KTCookie.get("app_engage_prebuilts_modal_displayed") !== "1") {
        setTimeout(function() {
          const modal = new Modal(engagePrebuiltsModal);
          modal.show();
